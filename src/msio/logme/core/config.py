...
from pydantic import BaseSettings, EmailStr, SecretStr, validator, PostgresDsn
...
def load_config_from_file() -> Settings:
    ...
    with open(CONFIG_FILE, 'r') as f:
        ...
        config = Settings(PROJECT_NAME=data.get('MSIO_LOG_ME_PROJECT_NAME', default='LogMe'),
                          ...
                          SECRET_KEY=data.get('MSIO_LOG_ME_SECRET_KEY', default='mysecretkey'),
                          ACCESS_TOKEN_EXPIRE_MINUTES=data.get('MSIO_LOG_ME_ACCESS_TOKEN_EXPIRE_MINUTES', default=30),
...
def load_config_file_from_env() -> Settings:
    config = Settings(PROJECT_NAME=getenv('MSIO_LOG_ME_PROJECT_NAME', default='LogMe'),
                      ...
                      ACCESS_TOKEN_EXPIRE_MINUTES=getenv('MSIO_LOG_ME_ACCESS_TOKEN_EXPIRE_MINUTES', default=30),
